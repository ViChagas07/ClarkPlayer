          ...
          <div className="p-6 border-b border-clark-steel/20 flex-shrink-0">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative flex-shrink-0">
                ...
                <div className="relative w-9 h-9 rounded-xl overflow-hidden flex items-center justify-center ring-1 ring-clark-gold/40">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/logo.png" alt="ClarkPlayer" className="w-full h-full object-contain" />
                </div>
              </div>
