...
export async function generateMetadata({ params, searchParams }: Props): Promise<Metadata> {
  ...
  const name: string | undefined = resolvedParams?.name
  const artistName = name ? safeDecodeURI(name) : 'Artist'
  ...
  const keywords = [artistName, `${artistName} music`, `${artistName} songs`, `${artistName} artist`, `${artistName} top tracks`, 'ClarkPlayer']
