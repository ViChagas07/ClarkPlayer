      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="relative group">
            <button className="flex items-center gap-2 px-3 py-2 bg-clark-bg-secondary rounded-lg font-body text-sm text-clark-text-muted hover:text-clark-text-primary transition-colors border border-clark-steel/40">
              {t('sortAction')}
            </button>
            <div className="absolute right-0 top-full mt-1 w-48 bg-clark-bg-secondary border border-clark-steel/20 rounded-lg shadow-card opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10">
              {([
                ['title', t('titleColumn')],
        ...
        <div className="grid grid-cols-[40px_1fr_1fr_80px_60px_40px] gap-4 px-4 py-2 font-body font-medium text-xs text-clark-text-muted uppercase tracking-wider border-b border-clark-steel/20">
          ...
          <button onClick={() => handleSort('album')} className="text-left">
        ...
        <div className="space-y-0.5">
          {isLoading
            ? Array.from({ length: 20 }).map((_, i) => (
                <div key={i} className="grid grid-cols-[40px_1fr_1fr_80px_60px_40px] gap-4 px-4 py-3 h-14 items-center bg-clark-bg-secondary/50 rounded-lg animate-pulse">
                  ...
                  <div className="w-24 h-4 bg-clark-steel/20 rounded" />
                  <div className="w-10 h-4 bg-clark-steel/20 rounded ml-auto" />
                  <div className="w-10 h-5 bg-clark-steel/20 rounded" />
                  <div className="w-4 h-4 bg-clark-steel/20 rounded" />
                </div>
              ))
