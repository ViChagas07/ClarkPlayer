...
import { Plus, Play, Lock, Clock, Calendar, ArrowDownAZ, ArrowUpAZ } from 'lucide-react'
...
export default function PlaylistsPage() {
  ...
  const allPlaylists = [...mockPlaylists, ...playlists]
  ...
  return (
    <AppShell>
      <div className="space-y-6">
        ...
        {/* Sort + New Playlist — same horizontal line */}
